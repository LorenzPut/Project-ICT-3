...
{
    internal class LifeItem : GameObject
    {
        //Deze code code komt grotendeels overeen met de andere GameObjecten (die niet held of vijand zijn). 
        //Het enige verschil zijn dat er een andere afbeelding wordt ingeladen en dat er een bool gedeclareerd staat die bepaalt wanneer het leventje "opgeraapt" wordt.
        //Dit betekent dat er een "botsing" voordoet tussen de held en het LifeItem, wordt op true gezet in het level waar de botsingen met de achtergrond gecontroleerd worden.
