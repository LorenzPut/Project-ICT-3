...
namespace PlatformGame
{
    internal class Item : GameObject
    {
        ...
        //Het enige verschil zijn dat er een andere afbeelding wordt ingeladen en dat er een bool gedeclareerd staat die bepaalt wanneer het object "opgeraapt" wordt.
        //Dit betekent dat er een "botsing" voordoet tussen de held en de item, wordt op true gezet in het level waar de botsingen met de achtergrond gecontroleerd worden.
