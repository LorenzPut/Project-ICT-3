...
namespace PlatformGame
{
    class Hero : GameObject
    {
       ...
       //Deze variabelen bepalen :  
        ...
        public bool MoveRight, MoveLeft, Jump = false, Savejump = false, Invincible = false, Level2 = false, Plustime, IamDead = false, Finish = false;
        ...
        public Hero(int x, int y)
        {
            try
            {
                ...
                Lowercollisionrectangle = new Rectangle((Position.X+1), (Position.Y + 75), 48, 5);
            }
        ...
        public override void Update()
        {
            ...
            Lowercollisionrectangle.X = (Position.X + 1);
